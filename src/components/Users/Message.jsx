...
const UserMessages = ()=>{
   ...
   return (
     <div className="flex flex-col h-auto bg-[#475569] mx-4 md:m-0 p-4 w-full md:w-2/5 justify-between mb-10 rounded-lg">
    <div>
     <ChatBubble message="Hello!" isUser={true} />
      ...
      <form action="" className="self-start mb-[80px] relative">
